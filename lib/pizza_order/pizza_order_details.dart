...
import 'package:flutter_animation/pizza_order/widget/pizza_cart_icon.dart';
              ...
              children: [
                Center(
                  child: Transform(
                    ...
                    child: Image.asset("assets/pizza_order/box_inside.png",
                  ...
                  Center(
                    child: Transform(
                      ...
                      transform: Matrix4.identity()
                        ..setEntry(3, 2, 0.003)
                        ..rotateX(degreesToRads(boxClosingValue)),
                      child: Image.asset("assets/pizza_order/box_front.png",
                          height: boxHeight, width: boxWidth),
                    ),
                  ),
              ],
